...
namespace patternstests
{
	...
	public:
		...
		TEST_METHOD(ShouldCreateBombedWall)
		{
			...
			//WHEN
			auto bombed_wall = patterns::BombedWall(bombed);
		...
		{
			//GIVEN
			auto existing_bombed_wall = patterns::BombedWall(true);

			//WHEN
			auto bombed_wall = patterns::BombedWall(existing_bombed_wall);
		...
		{
			//GIVEN
			auto existing_bombed_wall = patterns::BombedWall(false);
