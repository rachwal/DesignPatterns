...
namespace patternstests
{
	...
	public:
		...
		TEST_METHOD(ShouldCreateRoomWithABomb)
		{
			...
			//WHEN
			auto room_with_a_bomb = patterns::RoomWithABomb(expected_room_number, bombed);
		...
		TEST_METHOD(ShouldCreateRoomWithoutBombFromAnotherRoomWithoutBomb)
		{
			...
			auto expected_room_number = 4;
			auto bombed = false;
			auto existing_room_with_a_bomb = patterns::RoomWithABomb(expected_room_number, bombed);

			//WHEN
			auto room_with_a_bomb = patterns::RoomWithABomb(existing_room_with_a_bomb);
