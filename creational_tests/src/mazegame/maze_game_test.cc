...
namespace creationaltests
{
	...
	public:
		...
		TEST_METHOD(ShouldCreateMazeUsingSingletonMazeFactory)
		{
			...
			//WHEN
			maze = maze_game.CreateMaze(*MazeFactory::Instance());
		...
		TEST_METHOD(ShouldCreateMazeUsingStandardMazeBuilder)
		{
			...
			MazeGame maze_game;
			Maze* maze;
			StandardMazeBuilder standard_maze_builder;
		...
		TEST_METHOD(ShouldCreateMazeUsingCountingMazeBuilder)
		{
			...
			MazeGame maze_game;
			Maze* maze;
			CountingMazeBuilder counting_maze_builder;
		...
		TEST_METHOD(ShouldCreateMazeUsingMazePrototypeFactory)
		{
			...
			MazeGame maze_game;
			Maze* maze;
			MazePrototypeFactory maze_prototype_factory(new Maze, new BombedWall(true), new EnchantedRoom(66, Spell("abracadabra")), prototype_door);
