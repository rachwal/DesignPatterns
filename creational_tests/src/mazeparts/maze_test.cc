...
namespace creationaltests
{
	...
	public:
		...
		TEST_METHOD(ShouldAddMultipleRooms)
		{
			...
			auto existing_south_room = creational::Room(south_room_number);
			auto north_room_number = 2;
			auto existing_north_room = creational::Room(north_room_number);
			auto west_room_number = 3;
			auto existing_west_room = creational::Room(west_room_number);
			auto east_room_number = 4;
			auto existing_east_room = creational::Room(east_room_number);
			creational::Maze maze;
		...
		TEST_METHOD(ShouldCreateMazeFromExistingMaze)
		{
			...
			//WHEN
			auto maze = creational::Maze(existing_maze);
