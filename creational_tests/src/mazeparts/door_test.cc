...
namespace creationaltests
{
	...
	public:
		...
		TEST_METHOD(ShouldCreateNotEnteredDoor)
		{
			...
			auto east_room = creational::Room(east_room_number);
			auto west_room_number = 31;
			auto west_room = creational::Room(west_room_number);

			//WHEN
			auto door = creational::Door(east_room, west_room);
		...
		TEST_METHOD(ShouldCreateFromAnotherDoor)
		{
			...
			auto west_room_number = 31;
			auto west_room = creational::Room(west_room_number);
			auto existing_door = creational::Door(east_room, west_room);
			existing_door.Enter();

			//WHEN
			auto door = creational::Door(existing_door);
		...
		TEST_METHOD(ShouldInitializeDoor)
		{
			...
			auto west_room_number = 22;
			auto west_room = creational::Room(west_room_number);
			auto door = creational::Door(creational::Room(1), creational::Room(2));
