...
namespace structural
{
	...
	{
		equipment_ = new operational::List<EquipmentInterface*>();
	}
	...
	operational::IteratorInterface<foundation::EquipmentInterface*>* CompositeEquipment::CreateIterator()
	{
		return new operational::ListIterator<EquipmentInterface*>(equipment_);
	}
}
